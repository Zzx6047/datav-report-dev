          ...
          <div class="chart-wrapper">
            <div class="chart-inner">
              <div class="chart">
                ...
                <div class="chart-data">{{userCount | formate}}</div>
                <v-chart :options="searchUserOption"></v-chart>
              </div>
              <div class="chart">
                <div class="chart-title">搜索量</div>
                <div class="chart-data">{{searchCount | formate}}</div>
            ...
            <div class="tabel-wrapper">
              <el-table :data="tableData">
                ...
                <el-table-column prop="users" label="总搜索用户"></el-table-column>
                <el-table-column prop="range" label="搜索占比"></el-table-column>
              </el-table>
              <el-pagination
                layout="prev, pager, next" :total="total" :page-size="pageSize" background @current-change="onPageChange">
              </el-pagination>
            </div>
          </div>
        </template>
